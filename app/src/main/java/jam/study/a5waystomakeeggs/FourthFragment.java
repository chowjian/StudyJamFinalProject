...
public class FourthFragment extends Fragment {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (isNetworkAvailable()) {
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("vnd.youtube://R4vDqlKMbrk"));
    ...
    /**
     *  Creating an instance for class FourthFragment
     * @return The instance of FourthFragment
     */
